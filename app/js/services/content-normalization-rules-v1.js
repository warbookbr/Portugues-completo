export const LEGACY_COMPLETION_RULES_V1 = Object.freeze({
  'N0-U01-L01': {
    clusters: [
      {
        id: 'modalityDistinction',
        required: true,
        evidenceIds: ['L01-A01', 'L01-C03'],
        satisfaction: 'DEMONSTRATED_REQUIRED'
      }
    ],
    nonCompensable: true,
    activityPolicies: {
      'L01-A01': { threshold: 0.75 }
    }
  },
  'N0-U01-V01': {
    clusters: [
      {
        id: 'auditoryAndModality',
        required: true,
        evidenceIds: ['V01-Q01', 'V01-Q02'],
        satisfaction: 'DEMONSTRATED_REQUIRED'
      },
      {
        id: 'graphicSystem',
        required: true,
        evidenceIds: ['V01-Q03', 'V01-Q04', 'V01-Q05'],
        satisfaction: 'DEMONSTRATED_REQUIRED'
      },
      {
        id: 'visualOrganization',
        required: true,
        evidenceIds: ['V01-Q06', 'V01-Q07'],
        satisfaction: 'DEMONSTRATED_REQUIRED'
      },
      {
