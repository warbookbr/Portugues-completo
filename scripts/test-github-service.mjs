...
import { GitHubService, PROGRESS_GIST_FILENAME } from '../app/js/services/github-service.js';
...
console.log('GitHubService P5: identidade, criação/leitura/atualização de Gist e headers de autenticação/versionamento validados sem rede.');
